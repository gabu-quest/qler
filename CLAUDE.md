...
**Fully implemented.** v0.4.0 with timeouts, batch enqueue, progress, unique jobs, Prometheus metrics, logler logs CLI. 588 passing tests.
...
- [ROADMAP.md](./ROADMAP.md) — M0–M23 complete (v0.4.0). M24+ planned.
