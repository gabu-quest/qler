---
name: code-reviewer
description: "Use this agent to review code for quality, patterns, and improvements. Good for PR reviews, reviewing changes before commit, or getting a second opinion on implementation choices. Use after writing significant code or when the user asks for code review."
model: sonnet
---
